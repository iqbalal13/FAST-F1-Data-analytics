...
# API FASTF1
print("Memuat data sesi untuk GP Italia (Monza) 2025...")

session_ita_2025 = ff1.get_session(2025, 'Italy', 'R')
...
# 3. Definisikan warna dasar untuk garis setiap pembalap agar mudah diikuti
driver_colors = {
    'VER': 'darkblue',
    'NOR': '#FF8700',   # Oranye McLaren
    'PIA': '#FF9F3A',   # Oranye lebih terang
    'LEC': 'red',
    'RUS': 'cyan'
}
...
# 6. Judul dan Label
ax.set_title("Race Pace and Tire Strategy - Monza GP 2025")
